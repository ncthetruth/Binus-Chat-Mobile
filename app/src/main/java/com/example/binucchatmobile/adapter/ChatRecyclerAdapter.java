...
public class ChatRecyclerAdapter extends FirestoreRecyclerAdapter<ChatMessageModel, ChatRecyclerAdapter.ChatModelViewHolder> {
    ...
    class ChatModelViewHolder extends RecyclerView.ViewHolder{
        ...
        public ChatModelViewHolder(@NonNull View itemView) {
            ...
            leftChatLayout = itemView.findViewById(R.id.contactChatLayout);
            rightChatLayout = itemView.findViewById(R.id.userChatLayout);
            leftChatTextview = itemView.findViewById(R.id.contactChatTV);
            rightChatTextview = itemView.findViewById(R.id.userChatTV);
        }
    }
}
